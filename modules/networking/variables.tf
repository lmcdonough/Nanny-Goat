...
variable "name" {
  description = "The name of the VPC which will be used in the as an identifier on all the resources"
  type        = string
  default     = ""
}
...
variable "instance_tenancy" {
  description = "A tenancy option for the instances launched into the VPC"
  type        = string
  default     = "default"
}

variable "azs" {
  description = "A lisft of availability zones names or ids in the region"
}
